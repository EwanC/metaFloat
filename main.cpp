...
class IEEE_754 {
 private:
  ...
  // TODO: Implement this
  constexpr const char* calc_float_str() const { return "-1.234"; }
 ...
 public:
  ...
  void print() {
    ...
    print_colour<console_blue, exponent_bits>(
        std::bitset<exponent_bits>(exponent));
    print_colour<console_green, mantissa_bits>(
        std::bitset<mantissa_bits>(mantissa));
    std::cout << std::endl;
